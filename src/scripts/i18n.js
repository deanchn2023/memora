...
const translations = {
  zh: {
    ...
    'insight.loadingRelationship': '加载人脉图谱...',
    'insight.activationTitle': '⚡ 知识活化推荐',
    'insight.refreshRecommend': '刷新推荐',
    'insight.relationship': '人脉图谱',

    // 关系人脉
    'relationship.total': '总人数',
    'relationship.frequent': '高频',
    'relationship.recent': '近期活跃',
    'relationship.stale': '需联系',
    'relationship.searchPlaceholder': '搜索人名、项目、公司...',
    'relationship.filterAll': '全部',
    'relationship.filterFrequent': '高频',
    'relationship.filterRecent': '近期',
    'relationship.filterStale': '需联系',
    'relationship.aiAnalyze': 'AI 分析',
    'relationship.aiScan': 'AI 扫描人脉',
    'relationship.emptyTitle': '暂无人脉数据',
    'relationship.emptyHint': '当你复制或记录包含人名的信息时，Memora 会自动提取并积累人脉关系',
    'relationship.noMatch': '未找到匹配的人脉',
    'relationship.interactions': '交互次数',
    'relationship.lastContact': '上次联系',
    'relationship.contactStatus': '联系状态',
    'relationship.relatedProjects': '关联项目',
    'relationship.relatedPersons': '相关人脉',
    ...
    'profile.professionPh': '如：产品经理',
    'profile.organization': '组织',
    'profile.organizationPh': '如：腾讯',
    'profile.industry': '行业',
    'profile.industryPh': '如：互联网',
    'profile.region': '地区',
    'profile.regionPh': '如：深圳',
    'profile.address': '地址',
    'profile.avatar': '头像',
    ...
    'settings.agent.autoFillHint': '✅ 已自动应用到所有专业 Agent',
    'settings.agent.advancedTitle': '高阶配置',
    'settings.agent.advancedBadge': '各 Agent 独立配置',
    'settings.agent.advancedBadgeCustom': '已自定义部分 Agent',
    'settings.agent.advancedDesc': '为不同功能的 Agent 配置独立的 AppKey。留空时自动使用上方通用 AppKey。',
  ...
  en: {
    ...
    'task.sort.latest': 'Sort by latest',
    ...
    'insight.loadingRelationship': 'Loading relationship network...',
    'insight.activationTitle': '⚡ Knowledge Activation',
    'insight.refreshRecommend': 'Refresh',
    'insight.relationship': 'Network',

    // Relationship
    'relationship.total': 'Total',
    'relationship.frequent': 'Frequent',
    'relationship.recent': 'Recent',
    'relationship.stale': 'To Contact',
    'relationship.searchPlaceholder': 'Search name, project, company...',
    'relationship.filterAll': 'All',
    'relationship.filterFrequent': 'Frequent',
    'relationship.filterRecent': 'Recent',
    'relationship.filterStale': 'To Contact',
    'relationship.aiAnalyze': 'AI Analyze',
    'relationship.aiScan': 'AI Scan Network',
    'relationship.emptyTitle': 'No network data yet',
    'relationship.emptyHint': 'When you copy or record information with names, Memora automatically extracts and accumulates relationships',
    'relationship.noMatch': 'No matching contacts',
    'relationship.interactions': 'Interactions',
    'relationship.lastContact': 'Last Contact',
    'relationship.contactStatus': 'Status',
    'relationship.relatedProjects': 'Related Projects',
    'relationship.relatedPersons': 'Related Contacts',
    ...
    'profile.professionPh': 'e.g. Product Manager',
    'profile.organization': 'Organization',
    'profile.organizationPh': 'e.g. Tencent',
    'profile.industry': 'Industry',
    'profile.industryPh': 'e.g. Internet',
    'profile.region': 'Region',
    'profile.regionPh': 'e.g. Shenzhen',
    ...
    'settings.agent.autoFillHint': '✅ Auto-applied to all specialized Agents',
    'settings.agent.advancedTitle': 'Advanced Config',
    'settings.agent.advancedBadge': 'Per-Agent Config',
    'settings.agent.advancedBadgeCustom': 'Customized Agents',
    'settings.agent.advancedDesc': 'Configure independent AppKeys for different Agent functions. Leave empty to use the general AppKey above.',
