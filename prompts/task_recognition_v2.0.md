...
- **title 严格 ≤20 字**
- **description 必须包含足够的上下文信息**：当输入文本包含背景信息+待办任务时，description 不能只写待办本身，必须包含让人理解待办所需的上下文。例如：输入"BSC分工：p6 公有云...p11 打法思路2 - 国宇" + "@Dean 准备起来吧"，description 应为"BSC分工表中@Dean需准备的待办（涉及p6公有云收入、p7私有化收入等6项分工）"，而非仅仅"准备起来"
